          ...
          <div className="data-home">
            ...
            <h1 className="">
              ...
              <span className="home-title">
                {" "}
                ذَكّـــــــــرنــــي الإســلامــــــــي{" "}
              </span>
            </h1>
            <p>
              من خلال هذا الموقع يمكنك قراءة جميع سور القران القران الكريم كاملا
              كما يمكنك ايضا الإستماع أليه بصوت جميع قُراءّ , كما يمكنك ايضا
              قراءة بعض الأحاديث النبوية الشريفة و معرفة مواقيت الصلاة و قراءة
              أذكار الصباح و المساء و الإستماع اليها ايضاء .
            </p>
            <button className="home-button-section">
              <a href="#QURAN">
                هيا نبدء <i class="fa-solid fa-chevron-left color-icon "></i>
              </a>
            </button>
          </div>
        </div>
            ...
            <div className="row quran">
              <div className="col-md-6 ">
                <div className="quran-data text-center ">
                  ...
                  <p>
                    {" "}
                    يمكنك قراءة جميع ســـور الـــقـــران الـــكـــريم كاملة. كما
                    يمكنك الاستماع الي القُرْآنِ الكَرِيمِ كاملا بتدبر بصوت اي
                    قارئ من اختيارك .
                  </p>
                  <button className="btn-1">
                    <Link to={"/quran"}>
                      {" "}
                      قـــراءة و إستـــماع جميع سور الـــقـــرآن الكريم{" "}
                      <i class="fa-solid fa-book-open "></i>
                    </Link>
                  </button>
                  <button className="btn-2">
                    <Link to={"/listen"}>
                      الإســـتماع الي الـــقـــرآن الـــكـــريـــم{" "}
