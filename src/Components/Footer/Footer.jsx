    ...
    <>
      <div className="footer">
        <div class="coppright text-center">
          جميع حقوق النشر محفوظة &copy;{" "}
          <strong>
            <span class="specail">(ذَكّــــــرنــــي)</span>
          </strong>
        </div>
        <div class="credited text-center">
          ...
          <span class="me">
            {" "}
            <strong class="specail">مـــحــــــمد بـــدر إسمـــاعـــيل </strong>
          </span>
        </div>
        <div class="icons text-center">
          <a href="mailto:badr59497@gmail.com" target="_blank">
