        ...
        <div className="suwar-contanier" id="LISTREADERS">
          <div className="title">
            <div className="text-center">
              <h5>
                {" "}
                جــــــمــــــيــــــع قُـــــــــرَّاء اَلــــــقُــــــرآن
                اَلــــــكــــــرِيــــــم{" "}
              </h5>
            </div>
            <div className="quran-title mb-4 ">
              <h3 className="mt-3 mb-3 text-center">
                استمع الي الـــــقُـــــرْآنِ الـــــــكَــــــرِيــــــم
                بقــــــارئ مــن اختــــيــــارك{" "}
              </h3>
            ...
            <form className="mt-4 text-center">
              <div class="form-search m-auto">
                <input
                  ...
                  placeholder="ادخــــل اســــم الــــقــــارئ....."
                />
