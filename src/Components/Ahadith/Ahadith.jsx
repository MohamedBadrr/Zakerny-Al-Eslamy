                  ...
                  <div className="bokhaaryy">
                    <div className="title-ahadith titleahadithWith">
                      <div className="text-center">
                        <h5 className="">
                          {" "}
                          مــجــمــوعــة من الأحـــــاديـــــث الــنــبــوية
                          الشــريــفة للصــــحيــــحــــي البُــخــاري و
                          مُــســلــم .{" "}
                        </h5>
                      </div>
                      <div className="ahadith-title mb-4 ">
                        <h3 className="mt-3 mb-3 text-center">
                          {" "}
                          الأحـــــــاديـــــــث
                          الـــــــنـــــــبـــــــويـــــــة
                          الشـــــــريـــــــفـــــــة{" "}
                        </h3>
                    ...
                    <div className="container hadithSection">
                      <div className=" section ahadith p-5">
                        <h3 className="text-center pb-3 title-bokhary">
                          مجــــــمــــــوعة احــــــاديــــــث من
                          صحــــــيــــــح البُــــــخــــــاري{" "}
                        </h3>
                        <div className="onehadith" id="AHADITHBOSHARY">
                          <p>{firsthadirh}</p>
                        </div>
                        <div className="buttonss-ahadith">
                          <a href="#AHADITHBOSHARY">
                            {" "}
                            <button
                              className="netx-btn"
                              onClick={() => {
                      ...
                      <div className="moslem withoutHeader">
                        <div className=" section ahadith-moslem p-5 ">
                          <h3 className="text-center pb-3 title-bokhary">
                            مجــــــمــــــوعة احــــــاديــــــث من
                            صحــــــيــــــح مُــســلــم{" "}
                          </h3>
                          <div className="onehadith" id="AHADITHMOSLEM">
                            <p>{firsthadirhMoslem}</p>
                          </div>
                          <div className="buttonss-ahadith">
                            <a href="#AHADITHMOSLEM">
                              <button
                                className="netx-btn"
                                onClick={() => {
                                  setIndexmoslem(indexmoslem + 1);
                                  getHadithMoslem(indexmoslem);
                                }}
                              >
                                {" "}
                                التالي{" "}
...
export const Ahadith2withoutheader = () => {
  ...
  return (
    <div>
      <>
        <section id="#AhadithWithoutHeader">
          <div className="ahadith-section pt-1 edit-home-page">
            <div className="bokhaaryy">
              <div className="title-ahadith edit-ahadith-header">
                <div className="text-center">
                  <h5 className="">
                    {" "}
                    مــجــمــوعــة من الأحـــــاديـــــث الــنــبــوية
                    الشــريــفة للصــــحيــــحــــي البُــخــاري و مُــســلــم .{" "}
                  </h5>
                </div>
                <div className="ahadith-title mb-4 ">
                  <h3 className="mt-3 mb-3 text-center">
                    {" "}
                    الأحـــــــاديـــــــث الـــــــنـــــــبـــــــويـــــــة
                    الشـــــــريـــــــفـــــــة{" "}
                  </h3>
                  <div className="line-1 "></div>
                  <div className="line-2 "></div>
              ...
              <div className="container hadithSection">
                <div className=" section ahadith p-5">
                  <h3 className="text-center pb-3 title-bokhary">
                    مجــــــمــــــوعة احــــــاديــــــث من صحــــــيــــــح
                    البُــــــخــــــاري{" "}
                  </h3>
                  <div className="onehadith" id="#AhadithWithoutHeader">
                    <p>{firsthadirh}</p>
                  </div>
                  <div className="buttonss-ahadith">
                    <a href="#AhadithWITHOUTHEADER">
                      <button
                        className="netx-btn"
                        onClick={() => {
                          setIndex(index + 1);
                ...
                <div className="moslem withoutHeader">
                  <div className=" section ahadith-moslem p-5 ">
                    ...
                    <div className="buttonss-ahadith">
                      <a href="#AHADITHWIOURHEADERMOSLEM">
                        <button
                          className="netx-btn"
                          onClick={() => {
                            setIndexmoslem(indexmoslem + 1);
