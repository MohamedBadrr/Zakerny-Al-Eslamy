...
const Reader = () => {
  ...
  "١١٤ - سورة الناس",
    ...
    useEffect(() => {
      ...
      axios.get(`https://www.mp3quran.net/api/v3/reciters?language=ar&reciter=${readerId}`).
      then((resp)=>{
        ...
        else if(resp.data.reciters[0].moshaf[1].name === 'حفص عن عاصم - مرتل'){
        ...
        else if(resp.data.reciters[0].moshaf[2].name === 'حفص عن عاصم - مرتل'){
        ...
        else if(resp.data.reciters[0].moshaf[3].name === 'حفص عن عاصم - مرتل'){
        ...
        else if(resp.data.reciters[0].moshaf[4].name === 'حفص عن عاصم - مرتل'){
        ...
        else if(resp.data.reciters[0].moshaf[5].name === 'حفص عن عاصم - مرتل'){
        ...
        else if(resp.data.reciters[0].moshaf[6].name === 'حفص عن عاصم - مرتل'){
        ...
        Setreader({...reader,loading:false , err:"some thing went wrong ,please try again later"});
      })
    }, [] ) 
    ...
    function searchSoras() {
      setSearchsorasList({...searchsorasList,loading:true})
        ...
        setTimeout(() => {
          ...
          setSearchsorasList({ ...searchsorasList, results: filteredsoras ,loading:false });
  ...
  return (
    ...
    <div>
      ...
      <div className='suwar-contanier'>
              <div className='title'>
                    <div className='text-center'>
                            <h5> اســــــتــــــمــــــع اَلــــــقُــــــرآن اَلــــــكــــــرِيــــــم بــــــصــــــوت الـــقـــــــــــــــارئ :</h5>
                    </div>
                    <div className='quran-title mb-4 '>
                    <h3 className='mt-3 mb-3 text-center'>{reader.results.map((reader)=>{
                                  return(
                                    <>{reader.name}</>
                                  )
                        })}</h3>
              ...
              <form className='mt-4 text-center'>
                <div class="form-search m-auto">
                    <input type="text" className="input-search w-100" id="exampleInputEmail1" 
                      placeholder="ادخــــل اســــم الــــســــورة....." value={searchValue}
            ...
            <i class="fa-regular fa-rectangle-xmark" onClick={()=>{setShowsoundbox(false);
                  }}></i>
                                        ...
                                        searchsorasList.results.map((sora,index)=>{
                                            return(
                                                ...
                                                <h5 className='spesifcsora text-dark' key={index}>
                                                        {sora}
                                                        <a href="#READER"><i class="fa-solid fa-circle-play listen-icon text-white" 
                                                        onClick={()=>{getsoraSound(sowr.indexOf(sora)+1);
      ...
      <button className='up-button'><a href="#READER"><i class="fa-solid fa-chevron-up"></i></a></button>
      </section>
