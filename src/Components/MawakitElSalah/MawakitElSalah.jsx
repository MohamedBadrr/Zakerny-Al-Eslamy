...
const MawakitElSalah = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://api.aladhan.com/v1/timingsByCity/${getCurrentDate()}?city=cairo&country=Egypt&method=8`
      )
      .then((resp) => {
      ...
      <section id="#MAWAKITELSALAH">
        <div className="mawakitelsalah-section">
          <div className="container mawakitelsalah p-5 smalledit">
            ...
            <h1 className="mawakit-title">
              مــــــواقـــــيـــــت الصـــــلاة في مـــــصـــــر{" "}
            </h1>
            <div className="clock">
              الـــســـاعة الان : <span className="time">{arabicTime}</span>{" "}
            </div>
            ...
            <div className="prayers">
              <div className="pray">
                ...
                <h5 className="clock-salah text-white">
                  {" "}
                  {englishToArabicDigit(prayertimes.results.Fajr)} ص
                </h5>
              </div>
              <div className="pray">
                ...
                <h5 className="clock-salah  text-white">
                  {englishToArabicDigit(prayertimes.results.Sunrise)} ص
                </h5>
              </div>
              <div className="pray">
                <h3 className="salah">صــــلاة</h3>
                ...
                <h5 className="clock-salah text-white">
                  {englishToArabicDigit(prayertimes.results.Dhuhr)} م
                </h5>
              </div>
              <div className="pray">
                <h3 className="salah">صــــلاة</h3>
                ...
                <h5 className="clock-salah text-white">
                  {englishToArabicDigit(prayertimes.results.Asr)} م
                </h5>
              </div>
              <div className="pray">
                <h3 className="salah">صــــلاة</h3>
                ...
                <h5 className="clock-salah text-white">
                  {englishToArabicDigit(prayertimes.results.Maghrib)} م
                </h5>
              </div>
              <div className="pray">
                <h3 className="salah">صــــلاة</h3>
                ...
                <h5 className="clock-salah text-white">
                  {englishToArabicDigit(prayertimes.results.Isha)} م
                </h5>
              </div>
            </div>
            <p className="small-text">
              {" "}
              ( بـــاركَ الـــلـــهُ ف عمـــلاٍ قطعتُه الصـــلاة ){" "}
            </p>
          </div>
        </div>
      </section>
